...
export const contentAr: Content = {
  ...
  hero: {
    ...
    description: 'Data Scientist & Analyst based in Alexandria, Egypt. (Please translate bio to Arabic)',
    btnAbout: 'عني',
    btnProjects: 'عرض المشاريع',
  },
  about: {
    title: 'نبذة عني',
    p1: 'أنا <strong>عالم ومحلل بيانات</strong> مقيم في الإسكندرية، مصر. (Please translate to Arabic)',
    p2: '(Please translate to Arabic)',
